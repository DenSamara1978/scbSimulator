...
class scbSchemeAVX64 : public scbScheme
{
...
public:
	scbSchemeAVX64 (const wstring& name, int prep_count, int main_count, int statsens_count, int dynsens_count );
	virtual ~scbSchemeAVX64 () override;
