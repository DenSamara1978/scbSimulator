...
class scbSchemeSSE32 : public scbScheme
{
...
public:
	scbSchemeSSE32 ( const wstring& name, int prep_count, int main_count, int statsens_count, int dynsens_count );
	virtual ~scbSchemeSSE32 () override;
