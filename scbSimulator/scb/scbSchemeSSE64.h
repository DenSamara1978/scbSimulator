...
class scbSchemeSSE64 : public scbScheme
{
...
public:
	scbSchemeSSE64 ( const wstring& name, int prep_count, int main_count, int statsens_count, int dynsens_count );
	virtual ~scbSchemeSSE64 () override;
