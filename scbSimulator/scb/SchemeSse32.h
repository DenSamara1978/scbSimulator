...
namespace scb
{
	...
	class SchemeSse32 : public Scheme
	{
	public:
		SchemeSse32(const wstring& name, int nPrepareCircuits, int nMainCircuits, int nStaticSensitives, int nDynamicSensitives);
		virtual ~SchemeSse32() override;
	...
	private:
		...
		__m128i staticSensitives; // Статические чувствительности
