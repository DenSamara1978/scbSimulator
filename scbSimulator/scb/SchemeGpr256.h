...
namespace scb
{
	...
	class SchemeGpr256 : public Scheme
	{
	public:
		SchemeGpr256(const wstring& name, int nPrepareCircuits, int nMainCircuits, int nStaticSensitives, int nDynamicSensitives);
		virtual ~SchemeGpr256() override;
