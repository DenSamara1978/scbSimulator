...
class scbSchemeSSE128 : public scbScheme
{
	__m128i m_Status; // Слово состояния схемы
...
public:
	scbSchemeSSE128 ( const wstring& name, int prep_count, int main_count, int statsens_count, int dynsens_count );
	virtual ~scbSchemeSSE128 () override;
