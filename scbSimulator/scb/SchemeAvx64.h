...
namespace scb
{
	...
	class SchemeAvx64 : public Scheme
	{
	public:
		SchemeAvx64(const wstring& name, int nPrepareCircuits, int nMainCircuits, int nStaticSensitives, int nDynamicSensitives);
		virtual ~SchemeAvx64() override;
